...
<div id="main-wrapper">
    ...
    ***********************************-->
    <div class="nav-header">
        <a href="storespublic.php" class="brand-logo">
    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Stores</a></li>
                </ol>
            </div>
            <div class="row">
                <?php
                                ...
                                <div class='col-md-5 col-xxl-12'>
                                    <div class='new-arrival-product mb-4 mb-xxl-4 mb-md-0'>
                                        <div class='new-arrivals-img-contnent'>
                                            <img class='img-fluid' height='350px' width='400px' src='..//bashbord/uplodes/$img' alt=''>
                                        </div>
                                    </div>
                                </div>
                                <div class='col-md-7 col-xxl-12'>
                                    <div class='new-arrival-content position-relative'>
                                        <h4><a href='storesdetails.php?id=$id'>$name</a></h4>
                                        ...
                                        <p>Availability: <span class='item'> <i class='fa fa-check-circle text-success'></i></span></p>
                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="text-center mb-4">
                                        <img class="img-fluid rounded" width="78" src="../includes/images/avatar/1.jpg" alt="DexignZone">
                                    </div>
                                    <div class="mb-3">
