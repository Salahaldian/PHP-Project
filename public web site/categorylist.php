...
<div id="main-wrapper">
    ...
    ***********************************-->
    <div class="nav-header">
        <a href="categorylist.php" class="brand-logo">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                while ($row = mysqli_fetch_assoc($result)){
                    ...
                    $id = $row['id'];
                    echo "<div class='col-xl-3 col-lg-6 col-sm-6'>
                    <div class='card'>
                        <div class='card-body'>
                            <div class='new-arrival-product'>
                                <div class='new-arrival-content text-center mt-3'>
                                    <h4><a href='storespublic.php?id=$id'>$name</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
