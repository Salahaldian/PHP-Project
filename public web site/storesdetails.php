<?php
            ...
            include_once 'includ/conniction.php' ;
            ...
            $MAC = strtok($MAC, ' ');
                $id = $_GET['id'];
            // echo $MAC ;
echo $rate . 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa';
            $rate_query = "insert into rate ( mac , rating_val , store_id )
            values ( '$MAC' , '$rate' , '$id' )";

            $rate_result = mysqli_query($link , $rate_query) ;
...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>STORES DETAILS <3</title>

    <!-- FAVICONS ICON -->
    <link rel="stylesheet" href="includ/css.css">
    <link rel="shortcut icon" type="image/png" href="/includes/images/favicon.png" />
    <link rel="stylesheet" type="text/css" href="/includes/vendor/star-rating/star-rating-svg.css">
...
<div id="main-wrapper">
    ...
    ***********************************-->
    <div class="nav-header">
        <a href="storesdetails.php" class="brand-logo">
    ...
    ***********************************-->
    <?php
    include_once "../bashbord/includess/sidebar.php";
    ?>
    <!--**********************************
        Sidebar end
    ***********************************-->
    ...
    <div class="content-body">
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Store Details</a></li>
                </ol>
            </div>
            <div class="row">
                <?php
                include_once "includ/conniction.php";
                $id = $_GET['id'];
                $qurey = "SELECT * from store where id ='$id' ";
                                ...
                                <div class='col-xl-3 col-lg-6  col-md-6 col-xxl-5 '>
                                    ...
                                    <div class='tab-content'>
                                        <div role='tabpanel' class='tab-pane fade show active' id='first'>
                                            <img class='img-fluid' height='300px' width='300px' src='..//bashbord/uplodes/$img'' alt='Store Icone' >
                                        </div>
                                    </div>
                                </div>
                                <!--Tab slider End-->
                                <div class='col-xl-9 col-lg-6  col-md-6 col-xxl-7 col-sm-12'>
                                    <div class='product-detail-content'>
                                        ...
                                        <div class='new-arrival-content pr'>
                                            ...
                                            <p>Availability: <span class='item'> <i class='fa fa-check-circle text-success'></i></span>
                                            </p>
                                            <p>Address: <span class='item'>$address</span> </p>
                                            <p>Phone Number: <span class='item'>$phone</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                $MAC = strtok($MAC, ' ');
                                $id = $_GET['id'];
                                $is_query = "select * from rate where mac = '$MAC' and store_id = '$id'";
                                $is_result = mysqli_query($link , $is_query);


                                if (mysqli_num_rows($is_result)> 0){

                                    $is_rate = mysqli_fetch_assoc($is_result) ;
                                    $rate = $is_rate['rating_val'];
                                    echo '<h3> your rate :'.intval($rate).'</h3>' ;
                                    for ($i = 0 ; $i < $rate ; $i++){
                                        echo "<i class='fa fa-star checked'></i>"  ;
                                    }}else{

                                    echo "
                         <form action='storesdetails.php?id=$id' method='POST'>
                          <div class='rate'>
    ...
    ***********************************-->
    <?php
    include_once "../bashbord/includess/footer.php";
    ?>
    <!--**********************************
        Footer end
    ***********************************-->
...
<!-- Rating -->
<script src="../includes/vendor/star-rating/jquery.star-rating-svg.js"></script>
