...
if ($_SERVER['REQUEST_METHOD']=="POST") {
    ...
    echo $file_name;#  img4784-5745sfs.png
    $file_size = $_FILES[ 'img']['size'];
    $file_tmp = $_FILES['img']['tmp_name'];
    $type = $_FILES['img']['type'];
    $file_ext = strtolower(pathinfo($file_name, PATHINFO_EXTENSION));
    $file_new_name = strval(time()+rand(1,1000)) . ".$file_ext" ;
    $upload_path = 'uplodes/' . $file_new_name ;
...
{
    $id = $_GET['id'];
    $qurey = "SELECT name , Phone , address ,category_id , img from store  where id = '$id'";
    $result = mysqli_query($link,$qurey);
    $row = mysqli_fetch_assoc($result);
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    $qurey= "UPDATE store set name = '$name1' , address ='$addess' , Phone = '$phone' ,img = '$file_new_name' ,category_id = '$category'  where id = '$id'";
    $result = mysqli_query($link,$qurey);
    if ($result) {
...
<head>
    ...
    <link href="../includes/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
...
<div id="main-wrapper">
                            ...
                            <ul class="contacts">
                                ...
                                <li class="active dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/includes/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/includes/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/includes/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/includes/images/avatar/4.jpg" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/includes/images/avatar/5.jpg" class="rounded-circle user_img" alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                        ...
                        <div class="card-body msg_card_body dlab-scroll" id="dlab_W_Contacts_Body3">
                            <div class="d-flex justify-content-start mb-4">
                                <div class="img_cont_msg">
                                    <img src="/includes/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
                                </div>
                            ...
                            <div class="d-flex justify-content-end mb-4">
                                ...
                                <div class="img_cont_msg">
                                    <img src="/includes/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
                                </div>
                            </div>
                            <div class="d-flex justify-content-start mb-4">
                                <div class="img_cont_msg">
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                <div class="media me-2">
                                                    <img alt="image" width="50" src="/includes/images/avatar/1.jpg">
                                                </div>
    ...
    ***********************************-->
    <?php
    include_once "includess/sidebar.php";
    ?>
    <!--**********************************
        Sidebar end
    ***********************************-->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="needs-validation" novalidate action="<?php echo  $_SERVER['PHP_SELF']."?id=$id" ?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom01">Store Name
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input name="name" type="text" class="form-control" id="validationCustom01"  placeholder="Enter a Store Name.." required value="<?php echo $row['name']; ?>">
                                                    <div class="invalid-feedback">
                                                        Please enter a Stor Name.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom02">Address <span
                                                        class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input name="address" type="text" class="form-control" id="validationCustom02"  placeholder="Enter a Address.." required value="<?php echo $row['address']; ?>">
                                                    <div class="invalid-feedback">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom08">Phone (PS)
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input  name="phone" type="text" class="form-control" id="validationCustom08" placeholder="059-999-0000" required value="<?php echo $row['Phone']; ?> ">
                                                    <div class="invalid-feedback">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="form-file">
                                            <input name="img" type="file" class="form-file-input form-control">
                                        </div>
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Category</span>
                                        <select class="custom-select" id="select_category" name="category_id" required>
                                            <option value="" disabled><strong>category name:</strong></option>
                                            <?php
                                            $c_query ='select id , categories_name from categories' ;
...
***********************************-->
<!-- Required vendors -->
<script src="../includes/vendor/global/global.min.js"></script>

<script src="/includes/vendor/jquery-nice-select/js/jquery.nice-select.min.js"></script>

<script src="../includes/js/custom.min.js"></script>
<script src="../includes/js/dlabnav-init.js"></script>
