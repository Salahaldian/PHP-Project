                            ...
                            if (mysqli_num_rows($result)>0){
                                while ($row=mysqli_fetch_assoc($result)){
                                    ...
                                    echo "<tr>".
                                        ...
                                        "<td> <a href='editstores.php?id=" . $row['id'] . "' class='btn btn-outline-primary box-shadow-3 nr-1 nb-1 '><i class='icon-eye'></i> </a> </td>".
                                        " <td> <form class='delete_cat' action='deletecategory.php' method='post'>
