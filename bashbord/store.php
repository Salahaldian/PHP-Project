...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>STORES <3</title>

    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="/includes/images/favicon.png"/>
    <link href="../includes/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
    <link href="../includes/vendor/jquery-nice-select/css/nice-select.css" rel="stylesheet">
    <link rel="stylesheet" href="../includes/vendor/nouislider/nouislider.min.css">
    <!-- Style css -->
    ...
    <div class="nav-header">
        <a href="index.php" class="brand-logo">
            <svg class="logo-abbr" width="53" height="53" viewBox="0 0 53 53">
                <path d="M21.6348 8.04782C21.6348 5.1939 23.9566 2.87204 26.8105 2.87204H28.6018L28.0614 1.37003C27.7576 0.525342 26.9616 0 26.1132 0C25.8781 0 25.639 0.0403711 25.4052 0.125461L7.3052 6.7133C6.22916 7.105 5.67535 8.29574 6.06933 9.37096L7.02571 11.9814H21.6348V8.04782Z"
                      fill="#759DD9"/>
                <path d="M26.8105 5.97754C25.6671 5.97754 24.7402 6.90442 24.7402 8.04786V11.9815H42.8555V8.04786C42.8555 6.90442 41.9286 5.97754 40.7852 5.97754H26.8105Z"
                      fill="#F8A961"/>
                        ...
                        <div class="card-body contacts_body p-0 dlab-scroll  " id="dlab_W_Contacts_Body">
                            <ul class="contacts">
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/includes/images/avatar/4.jpg" class="rounded-circle user_img"
                                                 alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/includes/images/avatar/5.jpg" class="rounded-circle user_img"
                                                 alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/includes/images/avatar/1.jpg" class="rounded-circle user_img"
                                                 alt=""/>
                                            <span class="online_icon"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/includes/images/avatar/2.jpg" class="rounded-circle user_img"
                                                 alt=""/>
                                            <span class="online_icon offline"></span>
                                        </div>
                                        <div class="user_info">
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont">
                                            <img src="/includes/images/avatar/3.jpg" class="rounded-circle user_img"
                                                 alt=""/>
                                            <span class="online_icon"></span>
                                        </div>
                                        <div class="user_info">
                        ...
                        <div class="card-body msg_card_body dlab-scroll" id="dlab_W_Contacts_Body3">
                            <div class="d-flex justify-content-start mb-4">
                                <div class="img_cont_msg">
                                    <img src="/includes/images/avatar/1.jpg" class="rounded-circle user_img_msg"
                                         alt=""/>
                                </div>
                            ...
                            <div class="d-flex justify-content-end mb-4">
                                ...
                                <div class="img_cont_msg">
                                    <img src="/includes/images/avatar/2.jpg" class="rounded-circle user_img_msg"
                                         alt=""/>
                                </div>
                            </div>
                            <div class="d-flex justify-content-start mb-4">
        ...
        <div class="container-fluid">
            <div class="d-flex mb-3">
                <div class="mb-3 align-items-center me-auto">
                    ...
                    <span class="fs-12">Here are the stores and their details</span>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ( $row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<tr>" .
                                        ...
                                        "<td> <a href='editcategory.php?id=" . $row['id'] . "' class='btn btn-outline-primary box-shadow-3 nr-1 nb-1 '><i class='icon-eye'></i> </a> </td>" .
                                        " <td> <form class='delete_cat' action='deletestore.php' method='post'>
                                                    <input type='hidden' name='id' value='" . $row['id'] . "'>
                                                    <button type='button' class='btn btn-danger delete_cat' id='delete-btn'>
                                                        DELETE
                                                    </button>
                                                </form>  </td> "
                                        . "</tr>";
...
<script src="../includes/vendor/chart.js/Chart.bundle.min.js"></script>
...
<script src="../includes/js/plugins-init/datatables.init.js"></script>
