...
//{
//    $id = $_GET['id'];
//    $qurey = "SELECT username , password , status from users  where id = '$id'";
//    $result = mysqli_query($link,$qurey);
//    $row = mysqli_fetch_assoc($result);
//    if ($_SERVER['REQUEST_METHOD'] == "POST"){
//        $qurey= "UPDATE users set username = '$user' , password ='$password' , status =  '$status' , where id = '$id'";
//        $result = mysqli_query($link,$qurey);
//        if ($result) {
...
if ($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $query="UPDATE users set username = '$user'  , password ='$password' , status='$status'  where id ='".$_GET['id']."'";
                            ...
                            <div class="form-validation">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input name="user" type="text" class="form-control" id="validationCustom01"   required value="<?php echo $row['username']; ?>">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="validationCustom08">Password
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input  name="password" type="password" class="form-control" id="validationCustom08"  required value="<?php echo $row['password']; ?> ">
                                                    <div class="invalid-feedback">
                               ...
                               <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input name="status" type="text" class="form-control" id="validationCustom01"   required value="<?php echo $row['status']; ?>">
                                                    <div class="invalid-feedback">
