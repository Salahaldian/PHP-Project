...
if ($_SERVER['REQUEST_METHOD']=="POST") {
    ...
    $qurey1 = "INSERT INTO store (name,Phone,address,category_id,img) VALUES ('$name1','$phone','$addess','$category','$file_new_name')";
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input name="name" type="text" class="form-control" id="validationCustom01"  placeholder="Enter a Store Name.." required>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input name="address" type="text" class="form-control" id="validationCustom02"  placeholder="Enter a Address.." required>
                                                    <div class="invalid-feedback">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input  name="phone" type="text" class="form-control" id="validationCustom08" placeholder="059-999-0000" required>
                                                    <div class="invalid-feedback">
